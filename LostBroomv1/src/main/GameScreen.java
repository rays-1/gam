...
public class GameScreen extends JPanel implements Runnable{
    ...
    int playerX = 100,playerY = 100,speed = 8;
    ...
    public void update(){
        if(keylistener.pressedW == true){
            playerY -= speed;
        }
        else if(keylistener.pressedS == true){
            playerY += speed;
        }
        else if(keylistener.pressedA == true){
            playerX -= speed;
        }
        else if(keylistener.pressedD == true){
            playerX += speed;
        }
    }
    ...
    public void paintComponent(Graphics g){
        ...
        g2.fillRect(playerX, playerY, TILES_SIZE, TILES_SIZE);
    }
}
