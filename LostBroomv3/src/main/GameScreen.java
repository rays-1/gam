...
public class GameScreen extends JPanel implements Runnable{
    ...
    public final static int  TILES_DEFAULT_SIZE = 32; //default sprite size here is 32x32 px
    public final static float SCALE = 2.5f; // we scale it by 2.5x
    
    public final static int TILES_WIDTH = 16; // in your screen we need 16 blocks in width
    public final static int TILES_HEIGHT = 16; // and max of 16 block height
